...
typedef enum {
    AX_MODEL_OPEN_MAP_FAIL = -1,
    AX_MODEL_IMG_MMAP_FAIL = -2,
    AX_MODEL_DUM_MMAP_FAIL = -3,
    AX_MODEL_LOAD_IMG_TIMEOUT = -4,
    AX_MODEL_IMG_DATA_ERR = -5,
    AX_MODEL_NOT_MODEL_FILE = -6,
    AX_MODEL_OPEN_MEM_FILE = -7,
    AX_MODEL_NO_SUCH_MODE_FILE = -8,
    AX_MODEL_OTHER_ERROR = -9,
    AX_MODEL_ERROR_CODE_MAX
} MODEL_ERROR_CODE;
