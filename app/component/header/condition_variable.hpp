...
#pragma once
#if ((defined(__GNUC__) && __GNUC__ == 7) && (defined(__GNUC_MINOR__) && __GNUC_MINOR__ == 5) && (!defined(ARM32)))
#include <chrono>
#include <mutex>
...
public:
    ...
    condition_variable() noexcept {
        ...
        __gthrw_(pthread_cond_init)(&_M_cond, &attrs);
...
private:
    ...
    cv_status __wait_until_impl(unique_lock<mutex>& __lock, const chrono::time_point<__clock_t, _Dur>& __atime) {
