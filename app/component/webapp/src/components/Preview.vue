          ...
          <el-container id="video_container_0" class="preview_container">
            ...
            <el-footer class="video_controls_container" height="30px">
              ...
              <div class="right_controls_container">
                <div class="ezoom" >
                  <el-slider class="ezoom_slider" v-model="ezoom[0].ezoom_ratio" :min="0" :max="32" @mousedown.native="onEZoomMousedown" @input="onEZoom(0)" v-show="ezoomEnable"></el-slider>
                </div>
                ...
                <div class="draw_option">
                  <el-tooltip effect="dark" :content="!isTalking ? '开始对讲' : '停止对讲'" placement="top-end" :enterable="false">
                    <el-button size="mini" class="draw_button_enable" :icon="isTalking?'iconfont icon-mic-off':'iconfont icon-mic-on'" @click="onStartTalk()"
                      v-show="aenc_enable && sns0CurDisplayMediaType != 'MJPEG'"></el-button>
                  </el-tooltip>
                </div>
                <div class="draw_option">
                ...
                <div class="draw_option">
                  <el-tooltip effect="dark" :content="!streamOptions[0].isRecStart ? '开启录像' : '停止录像'" placement="top-end"
                    ...
                    <el-button size="mini" :disabled="!streamOptions[0].recEnable"
                      class="draw_button_enable" :icon="streamOptions[0].recIcon"
        ...
        <el-main class="preview_capture_left_container" v-show="preview_sns_mode === 2">
          <el-container id="video_container_1" class="preview_container">
            ...
            <el-footer class="video_controls_container" height="30px">
              ...
              <div class="right_controls_container">
                <div class="ezoom">
                  <el-slider class="ezoom_slider" v-model="ezoom[1].ezoom_ratio" :min="0" :max="32" @mousedown.native="onEZoomMousedown" @input="onEZoom(1)" v-show="ezoomEnable"></el-slider>
                </div>
                <div class="draw_option">
                  <el-tooltip effect="dark" :content="'抓拍'" placement="top-end">
                    <el-button size="mini" :class="{ 'draw_button_enable': true, 'draw_button_disable': false }"
    ...
    async getInfo(changeSNSVideo, snsId) {
      try {
        ...
        if (res.meta.status === 200) {
          ...
          // ezoom
          this.ezoom[0].ezoom_ratio =  res.data.info.ezoom[0].ezoom_ratio
          this.ezoom[0].center_offset_x =  res.data.info.ezoom[0].center_offset_x
          this.ezoom[0].center_offset_y =  res.data.info.ezoom[0].center_offset_y
          if (this.sns_num > 1) {
            this.ezoom[1].ezoom_ratio =  res.data.info.ezoom[1].ezoom_ratio
            this.ezoom[1].center_offset_x =  res.data.info.ezoom[1].center_offset_x
            this.ezoom[1].center_offset_y =  res.data.info.ezoom[1].center_offset_y
          }
