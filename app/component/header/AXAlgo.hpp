...
#define AX_APP_ALGO_DETECT_DEFAULT_OBJECT_FLITER (0xFF)
#define AX_APP_ALGO_DETECT_DEFAULT_OBJECT_PUSH_FLITER (0xFF)
#define AX_APP_ALGO_DETECT_DEFAULT_ANALAYZER (0xFF)
