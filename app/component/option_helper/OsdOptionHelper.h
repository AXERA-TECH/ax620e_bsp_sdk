...
#define APP_OSD_RECT(Handle, vecRgn) COsdOptionHelper::GetInstance()->GetOsdRect(Handle, vecRgn)
#define APP_OSD_POLYGON(Handle, vecRgn) COsdOptionHelper::GetInstance()->GetOsdPolygon(Handle, vecRgn)

#define SET_APP_OSD_RECT(Handle, vecRgn) COsdOptionHelper::GetInstance()->SetOsdRect(Handle, vecRgn)
#define SET_APP_OSD_POLYGON(Handle, vecRgn) COsdOptionHelper::GetInstance()->SetOsdPolygon(Handle, vecRgn)
