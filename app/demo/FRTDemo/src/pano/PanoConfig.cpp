...
AX_BOOL CPanoConfig::Init(AX_VOID) {
    if (!InitOsdConfig()) {
        return AX_FALSE;
    }
...
AX_BOOL CPanoConfig::InitOsdConfig(AX_VOID) {
...
AX_VOID CPanoConfig::OsdVideoChnIndex2IvpsGrp(AX_VOID) {
...
std::string CPanoConfig::GetResPath() {
#ifdef SLT
