...
#include "sample_vin_ivps_venc_rtsp.h"
...
static AX_S32 SAMPLE_IVPS_DeInit(AX_S32 nGrpId, AX_S32 nChnNum)
{
...
int main(int argc, char *argv[])
{
    ...
    while ((c = getopt(argc, argv, "c:m:e:l:d:a:r:h:v:z:t:n:")) != -1) {
        ...
        case 'z':
            ...
            break;
        case 't':
            if (gtVinParam.eMode != AX_GDC_ONLINE_VPP)
            {
                ALOGE("Only GDC->VPP online mode supports rotation!");
                exit(0);
            }
