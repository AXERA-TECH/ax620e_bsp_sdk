...
AX_S32 CBaseLinkage::Link(const LINK_MOD_INFO_T& tLinkModInfo) const {
    ...
    LOG_M_I(BASE_LINK, "Linkage setup: (%d, %d, %d) => (%d, %d, %d)", tPreMode.enModId, tPreMode.s32GrpId, tPreMode.s32ChnId,
            tCurMode.enModId, tCurMode.s32GrpId, tCurMode.s32ChnId);
...
AX_S32 CBaseLinkage::Unlink(const LINK_MOD_INFO_T& tLinkModInfo) const {
    ...
    LOG_M_I(BASE_LINK, "Linkage release: (%d, %d, %d) => (%d, %d, %d)", tPreMode.enModId, tPreMode.s32GrpId, tPreMode.s32ChnId,
            tCurMode.enModId, tCurMode.s32GrpId, tCurMode.s32ChnId);
