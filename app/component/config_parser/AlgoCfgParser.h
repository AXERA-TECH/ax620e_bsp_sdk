...
public:
    AX_BOOL GetConfig(std::map<AX_U8, AX_APP_ALGO_PARAM_T>& stAlgoParam, AX_APP_ALGO_AUDIO_PARAM_T& stAudioParam);
...
private:
    ...
    AX_BOOL ParseFile(const std::string& strPath, std::map<AX_U8, AX_APP_ALGO_PARAM_T>& stAlgoParam,
                      AX_APP_ALGO_AUDIO_PARAM_T& stAudioParam);
    AX_BOOL ParseJson(picojson::object& objJsonRoot, std::map<AX_U8, AX_APP_ALGO_PARAM_T>& stAlgoParam,
                      AX_APP_ALGO_AUDIO_PARAM_T& stAudioParam);
