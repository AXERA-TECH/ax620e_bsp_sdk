...
typedef struct audioPLAY_DEV_ATTR_T {
    ...
    audioPLAY_DEV_ATTR_T() {
        ...
        stVqeAttr = {.s32SampleRate = eSampleRate,
                     ...
                     .stNsCfg = {.bNsEnable = AX_FALSE, .enAggressivenessLevel = AX_AGGRESSIVENESS_LEVEL_HIGH},
                     .stAgcCfg = {.bAgcEnable = AX_FALSE, .enAgcMode = AX_AGC_MODE_FIXED_DIGITAL, .s16TargetLevel = -3, .s16Gain = 9}};
    }
