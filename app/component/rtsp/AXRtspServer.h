...
typedef enum axRTSP_SESS_MEDIA_TYPE_E { RTSP_SESS_MEDIA_VIDEO, RTSP_SESS_MEDIA_AUDIO, RTSP_SESS_MEDIA_BUTT } RTSP_SESS_MEDIA_TYPE_E;
...
public:
    ...
    AX_BOOL GetSessionAttr(AX_U32 nChannel, RTSP_SESS_ATTR_T& stSessAttr);
