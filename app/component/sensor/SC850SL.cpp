...
AX_VOID CSC850SL::InitSnsLibraryInfo(AX_VOID) {
    ...
    m_tSnsLibInfo.strLibName = "libsns_sc850sl.so";
    m_tSnsLibInfo.strObjName = "gSnssc850slObj";
#else
...
AX_VOID CSC850SL::InitMipiRxAttr() {
    ...
    m_tMipiRxDev.tMipiAttr.nDataRate = m_tSnsCfg.eSensorMode > AX_SNS_LINEAR_MODE ? 1458 : 1440;
