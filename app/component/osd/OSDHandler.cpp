                            ...
                            if ((dot8 & 0x80) == 0x80) {
                                for (AX_U16 hScale = 0; hScale < nScale; hScale++) {
                                    for (AX_U16 wScale = 0; wScale < nScale; wScale++) {
                                        ...
                                        if (OE_WIDTH_BACKWARD_RANGE == DrawPoint(pArgbBuffer, x0 + (k * 8 + dot) * nScale + wScale,
...
AX_VOID *COSDHandler::GenBitmap(wchar_t *pStr, AX_U8 *pBitmapBuffer, AX_U32 u32OSDWidth, AX_U32 u32OSDHeight, AX_S16 sX, AX_S16 sY,
...
COSDHandler::OSD_ERROR COSDHandler::DrawPoint(AX_U8 *pDataBuffer, AX_S16 x, AX_S16 y, AX_U32 u32OSDWidth, AX_U32 u32OSDHeight) {
    /* bitmap */
    if (x >= static_cast<AX_S16>(u32OSDWidth)) {
        return OE_WIDTH_BACKWARD_RANGE;
    }
...
AX_S32 COSDHandler::CalcStrSize(wchar_t *pTextStr, AX_U16 uFontSize, AX_U32 &u32OSDWidth, AX_U32 &u32OSDHeight) {
