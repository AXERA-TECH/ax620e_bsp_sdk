...
static const AX_U8 signature_rsa_pkcs1v15_abc_1024_sha384[] = {
...
static const AX_U8 signature_rsa_pkcs1v15_abc_1024_sha512[] = {
...
static const TestVectorRSAPKCS1v15_t testVectorsRsaPkcs1v15[] = {
    ...
    {
        "rsa-pkcs1v15-1024-sha384", 1024, 384, AX_CIPHER_RSA_SIGN_RSASSA_PKCS1_V15_SHA384,
        {
            der_rsa_pkcs1v15_key_1024 + 6, 1,
            der_rsa_pkcs1v15_key_1024 + 11, 128,
            der_rsa_pkcs1v15_key_1024 + 141, 3,
    ...
    {
        "rsa-pkcs1v15-1024-sha512", 1024, 512, AX_CIPHER_RSA_SIGN_RSASSA_PKCS1_V15_SHA512,
        {
            der_rsa_pkcs1v15_key_1024 + 6, 1,
            der_rsa_pkcs1v15_key_1024 + 11, 128,
            der_rsa_pkcs1v15_key_1024 + 141, 3,
