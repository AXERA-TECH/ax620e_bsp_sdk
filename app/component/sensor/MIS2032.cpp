...
AX_VOID CMIS2032::InitSnsLibraryInfo(AX_VOID) {
    ...
    m_tSnsLibInfo.strLibName = "libsns_mis2032.so";
    m_tSnsLibInfo.strObjName = "gSnsmis2032Obj";
#else
...
AX_VOID CMIS2032::InitMipiRxAttr() {
    ...
    m_tMipiRxDev.tMipiAttr.nDataRate = m_tSnsCfg.eSensorMode > AX_SNS_LINEAR_MODE ? 756 : 378;
