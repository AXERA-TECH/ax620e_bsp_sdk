...
static inline AX_AI_LAYOUT_MODE_E _AX_LAYOUT_MODE(AX_APP_AUDIO_LAYOUT_MODE_E eLayoutMode) {
    switch (eLayoutMode) {
        case AX_APP_AUDIO_LAYOUT_MIC_MIC:
            return AX_AI_MIC_MIC;
        case AX_APP_AUDIO_LAYOUT_MIC_REF:
