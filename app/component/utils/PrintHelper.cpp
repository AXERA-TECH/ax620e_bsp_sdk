...
AX_VOID CPrintHelper::PrintThreadFunc(CPrintHelper* pCaller) {
    ...
    while (pThis->m_bPrintThreadWorking) {
        ...
        if ((pThis->m_nTickEnd - pThis->m_nTickStart) >= PRINT_INTERVAL * 1000) {
            ...
            m_stDummyEncoderStatisticsInfo.Print();
...
AX_VOID CPrintHelper::FinalPrint() {
    ...
    for (AX_S32 i = 0; i < 3; i++) {
        ...
        m_stDummyEncoderStatisticsInfo.FinalPrint();
    }
}
...
AX_VOID CPrintHelper::Stop() {
    ...
    m_stDummyEncoderStatisticsInfo.ClearAll();
...
AX_VOID CPrintHelper::Add(PRINT_HELPER_MOD_E eModType, AX_U32 nChn) {
    ...
    switch (eModType) {
        ...
        case E_PH_MOD_MJENC:
            ...
            break;
        case E_PH_MOD_DUMMY_ENCODER:
            m_stDummyEncoderStatisticsInfo.Add(nChn);
            break;
        default:
            break;
    }
...
AX_VOID CPrintHelper::Reset(PRINT_HELPER_MOD_E eModType, AX_U32 nChn) {
    ...
    switch (eModType) {
        ...
        case E_PH_MOD_MJENC:
            ...
            break;
        case E_PH_MOD_DUMMY_ENCODER:
            m_stDummyEncoderStatisticsInfo.Reset(nChn);
            break;
        default:
            break;
    }
