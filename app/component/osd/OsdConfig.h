...
typedef struct _OSD_STR_ATTR_T {
    ...
    AX_CHAR szStr[MAX_OSD_STR_CHAR_LEN * 3]; /* 字符串内容 */
    AX_BOOL bInvEnable;                  /* 反色功能 */
    AX_U32 nColorInv;                    /* 反色后的颜色，A,R,G,B各一个字节 */
} OSD_STR_ATTR_T;
...
typedef struct _OSD_CFG_T {
    ...
    AX_S32 nZIndex;
    AX_S32 hRgn{-1}; /* hRgn will Generated from StartOSD */
    union {
