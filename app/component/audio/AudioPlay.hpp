...
public:
    ...
    AX_BOOL Play(AX_PAYLOAD_TYPE_E eType, const AX_U8 *pData, AX_U32 nDataSize, AX_U64 u64SeqNum, AX_U32 nChannel = 0);
    AX_BOOL PlayFile(AX_PAYLOAD_TYPE_E eType, const std::string &strFileName, AX_S32 nLoop, AUDIO_FILE_PLAY_CALLBACK callback,
