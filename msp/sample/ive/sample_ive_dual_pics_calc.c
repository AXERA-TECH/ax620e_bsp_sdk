    ...
    AX_CHAR* pchDstFileName, AX_U32 u32Width, AX_U32 u32Height, AX_U32 u32Mode, AX_S32 as32Type[], AX_CHAR *pchParamsList)
{
    ...
    if(u32Mode == 1 && pstTestDualPic->stSubCtrl.enMode == AX_IVE_SUB_MODE_SHIFT) {
        s32Ret = SAMPLE_COMM_IVE_CreateImage(&(pstTestDualPic->stDst), IMAGE_TYPE_SPECIFY(as32Type[2], AX_IVE_IMAGE_TYPE_S8C1), u32Width, u32Height);
        if(AX_SUCCESS != s32Ret) {
        ...
        s32Ret = SAMPLE_COMM_IVE_CreateImage(&(pstTestDualPic->stDst), IMAGE_TYPE_SPECIFY(as32Type[2], AX_IVE_IMAGE_TYPE_U16C1), u32Width, u32Height);
        if (AX_SUCCESS != s32Ret) {
            SAMPLE_IVE_PRT("Error(%#x),Create dst1 image failed!\n", s32Ret);
            SAMPLE_IVE_TestDualPic_Uninit(pstTestDualPic);
            return s32Ret;
        ...
        s32Ret = SAMPLE_COMM_IVE_CreateImage(&(pstTestDualPic->stDst), IMAGE_TYPE_SPECIFY(as32Type[2], AX_IVE_IMAGE_TYPE_U8C1), u32Width, u32Height);
        if (AX_SUCCESS != s32Ret) {
            SAMPLE_IVE_PRT("Error(%#x),Create dst1 image failed!\n", s32Ret);
            SAMPLE_IVE_TestDualPic_Uninit(pstTestDualPic);
            return s32Ret;
