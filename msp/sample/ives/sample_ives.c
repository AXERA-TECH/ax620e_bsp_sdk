...
AX_S32 main(AX_S32 argc, AX_CHAR *argv[]) {
    ...
    while (1) {
        ...
        static struct option long_options[] = {{"ref", required_argument, 0, LONG_OPTION_REF_IMAGE},
                                               ...
                                               {"path", required_argument, 0, LONG_OPTION_IMAGE_PATH},
        ...
        switch (c) {
            ...
            case LONG_OPTION_CUR_IMAGE:
                ...
                break;
            case LONG_OPTION_IMAGE_PATH:
                strcpy(szImgPath, optarg);
                bPathSet = AX_TRUE;
                break;
    ...
    if(!bPathSet) {
        strcpy(szImgPath, "/opt/data/ives");
    }
    ...
    switch (task) {
        case SAMPLE_TASK_MD:
            ret = SAMPLE_IVES_MD_ENTRY(szImgPath);
            break;
        case SAMPLE_TASK_OD:
            ret = SAMPLE_IVES_OD_ENTRY(szImgPath);
            break;
