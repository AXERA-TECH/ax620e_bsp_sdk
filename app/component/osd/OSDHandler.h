...
public:
    ...
    */
    ...
    AX_VOID *GenBitmap(wchar_t *pTextStr, AX_U8 *pBitmapBuffer, AX_U32 u32OSDWidth, AX_U32 u32OSDHeight, AX_S16 sX, AX_S16 sY,
                       AX_U16 uFontSize, OSD_ALIGN_TYPE_E enAlign = OSD_ALIGN_TYPE_LEFT_TOP);
...
private:
    ...
    OSD_ERROR DrawPoint(AX_U8 *pDataBuffer, AX_S16 x, AX_S16 y, AX_U32 u32OSDWidth, AX_U32 u32OSDHeight);
