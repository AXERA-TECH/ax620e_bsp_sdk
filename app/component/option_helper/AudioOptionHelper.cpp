...
const AX_APP_AUDIO_WELCOME_CFG_T& CAudioOptionHelper::GetWelcomeConfig() {
    return m_stAudioCfg.stWelcome;
}

const AX_APP_AUDIO_CFG_T& CAudioOptionHelper::GetAudioCfg() {
    return m_stAudioCfg;
}

AX_VOID CAudioOptionHelper::SetAudioCfg(const AX_APP_AUDIO_CFG_T& stAudioCfg) {
    m_stAudioCfg = stAudioCfg;
}
