...
#define PRINT_ELAPSED_SEC(fmt, ...) CElapsedTimer::GetInstance()->Stop(AX_TRUE, CElapsedTimer::seconds, fmt, ##__VA_ARGS__)
#define PRINT_ELAPSED_MSEC(fmt, ...) CElapsedTimer::GetInstance()->Stop(AX_TRUE, CElapsedTimer::milliseconds, fmt, ##__VA_ARGS__)
#define PRINT_ELAPSED_USEC(fmt, ...) CElapsedTimer::GetInstance()->Stop(AX_TRUE, CElapsedTimer::microseconds, fmt, ##__VA_ARGS__)
#define PRINT_ELAPSED_NSEC(fmt, ...) CElapsedTimer::GetInstance()->Stop(AX_TRUE, CElapsedTimer::nanoseconds, fmt, ##__VA_ARGS__)
