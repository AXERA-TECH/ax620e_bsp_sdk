...
#define SENSOR_OUT_WIDTH (1920)
#define SENSOR_OUT_HEIGHT (1080)
...
AX_VOID CSC200AI::InitSnsLibraryInfo(AX_VOID) {
    ...
    m_tSnsLibInfo.strLibName = "libsns_sc200ai.so";
    m_tSnsLibInfo.strObjName = "gSnssc200aiObj";
#else
...
AX_VOID CSC200AI::InitMipiRxAttr() {
    ...
    m_tMipiRxDev.tMipiAttr.nDataRate = m_tSnsCfg.eSensorMode > AX_SNS_LINEAR_MODE ? 800 : 400;
