...
typedef enum {
    ...
    E_OBS_TARGET_TYPE_AED,
    E_OBS_TARGET_TYPE_DUMMY_ENCODER,
    E_OBS_TARGET_TYPE_SPS,
    E_OBS_TARGET_TYPE_STREAM,
...
public:
    ...
    virtual AX_BOOL IsReadyForRecv(OBS_TARGET_TYPE_E eTarget, AX_U32 nGrp, AX_U32 nChn) {
        return AX_TRUE;
    };
};
